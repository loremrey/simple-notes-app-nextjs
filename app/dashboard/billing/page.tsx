...
import { StripePortal, StripeSubscriptionCreationButton } from '@/components/SubmitButton';
import { redirect } from 'next/navigation';
import { unstable_noStore as noStore } from 'next/cache';

const featureItems = [{ name: 'Feature 1' }, { name: 'Feature 2' }, { name: 'Feature 3' }, { name: 'Feature 4' }, { name: 'Feature 5' }];
			...
			<Card className="flex flex-col">
				<CardContent className="py-8">
					...
					<div className="mt-4 flex items-baseline text-6xl font-extrabold ">
						$30
						<span className="ml-1 text-2xl text-muted-foreground">/year</span>
					</div>
					<p className="mt-5 text-lg text-muted-foreground">Write as many notes as you want for 30$ per Year</p>
				</CardContent>
